# coding: utf-8
# Copy From https://github.com/facebookresearch/llama/blob/797488b96795c50ed79276b3aeab8f1436518301/server.py
...
if __name__ == "__main__":
    ...
    if dist.get_rank() == 0:
        ...
        def generate(config: Config):
            ...
            return {
                "results": [{"text": x.text, "token_ids_lst": x.token} for x in results]
            }
